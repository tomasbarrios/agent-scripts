...
- `css-debug-explain-solve-and-suggest` — diagnóstico CSS pedagógico en 4 fases. **Centralizada** — `skills/css-debug-explain-solve-and-suggest/`; `~/.bb/skills/` apunta acá por symlink (2026-07-20).
