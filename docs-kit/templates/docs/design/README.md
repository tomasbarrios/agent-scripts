...
Carpeta **conceptual**: problema, tono, copy, mockups. No define estándares de código.
...
4. **Mockups ≠ spec.**
5. **Sin número de release** en el nombre del archivo.

## Dónde va lo que no es diseño
